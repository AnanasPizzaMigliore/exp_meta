 ...
 *   detector.
 * @property image The optional [Bitmap] of the object, cropped from the image frame of the device camera
 *   feed from which it was detected.
 */
data class ObjectInfoRequest(val name: String, val image: Bitmap? = null)
